...
data-paddingleft="[0,0,0,0]">INConference 2017!</div>
              <!-- Layer 2 -->
...
data-textAlign="['left','left','left','left']">"OVERFLOW" GBT Kristus Alfa Omega, Semarang</div>
              <!-- Layer 3 -->
...
<a href="<?=base_url();?>register" class="btn btn-primary btn-rounded btn-xlg hidden-sm-down">Register Now</a>
<a href="<?=base_url();?>register" class="btn btn-primary btn-rounded btn-sm hidden-md-up">Register Now</a> </div>
            </li>
          </ul>

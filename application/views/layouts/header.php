          ...
          <div class="header-inner container">
            ...
            <div class="header-brand flex-first">
               <a class="header-brand-text" href="<?=base_url();?>" title="Incoference 2017 | Overflow ">
                <img class="logo-kecil" src="<?=base_url();?>assets/img/logo/logo_acara.png" alt="Incoference 2017">
              </a>
            </div>
            ...
            <div class="navbar navbar-toggleable-md navbar-toggleable-collapse">
              ...
              <div class="navbar-main collapse">
                ...
                <ul class="nav navbar-nav navbar-nav-onepager dropdown-effect-fade">
                  ...
                  <li class="nav-item"><a href="<?=base_url();?>register" data-toggle="scroll-link" class="nav-link">Register</a></li>
                </ul>
              </div>
              <!--/.navbar-collapse -->
            </div>

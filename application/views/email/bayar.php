              ...
              <tr>
                <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                                    ...
                                    <tbody>
                                      <tr>
                                        <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><table border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0">
                                            ...
                                            <tr>
                                              <td height="9" bgcolor="#2c3e50" class="contents" style="width:100%; border-top-left-radius:10px; border-top-right-radius:10px"></td>
                                            </tr>
                                          </table></td>
                                      </tr>
                                    </tbody>
                                      ...
                                      <tr>
                                        <td class="one-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;" bgcolor="#FFFFFF"><!-- ======= start header ======= -->
                                          ...
                                          <table cellpadding="0" cellspacing="0" border="0" width="100%">
                                            <tr>
                                              <td class="two-column" style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;text-align:center;font-size:0;"><!--[if (gte mso 9)|(IE)]>
                                                 ...
                                                 <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0;max-width: 800px; border-left:1px solid #e8e7e5; border-right:1px solid #e8e7e5; border-top:1px solid #e8e7e5" bgcolor="#FFFFFF">
                                                  <tr>
                                                    <td align="center"><img src="https://1.bp.blogspot.com/-UgCMFPSyXNE/WTaROtzaeUI/AAAAAAAAGAA/sIdhW0drXq0JQGjsXtj8uz7O1hPXCromgCLcB/s1600/header%2Bweb%2Bfix.jpg" width="100%" style="max-width:800px;"  alt=""/></td>
                                                  </tr>
                                                </table>
                                            ...
                                            <tr>
                                              <td align="left" style="padding-left:40px"><table border="0" cellpadding="0" cellspacing="0" style="border-bottom:2px solid #2c3e50" align="left">
                                                  <tr>
                  ...
                  <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                    <tr>
                      <td align="left" style="padding:0px 40px 40px 40px"><p style="color:#5b5f65; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif">Hai, <?=$nama;?></p>
                        <p style="color:#5b5f65; font-size:14px; text-align:left; font-family: Verdana, Geneva, sans-serif">
                        Terima kasih untuk partisipasi dalam pendaftaran INConference 2017 "Overflow". Berikut merupakan informasi yang perlu kamu ingat : </p>
                        <ul style="color:#5b5f65; margin-top: -5px;">
                          <li>Kode Pendaftaran : <b><?=$id;?></b></li>
                          <li>
                            Tipe Pendaftaran : <b><?php if($tipe == 1){
                                echo "Individu";
                              }else{
                                echo "Grup (" .$jumlah. " Orang)";
                                } ?> </b>
                          </li>
                        ...
                        <hr>
                         ...
                         <strong>Metode Pembayaran :</strong>
                          <ol style="color:#5b5f65; margin-top: -10px;font-size:12px; text-align:left; font-family: Verdana, Geneva, sans-serif">
                            ...
                            <li>Bukti pembayaran dapat dikirimkan melalui email inconference2017@gmail.com atau Jessica : +62 878-3467-9407 (WA Avaliable) dengan format konfirmasi:</li>
                          </ol>
                              <p style="font-weight: bold; font-size:12px; margin-left: 40px; font-style: italic;">BAYAR tipePendaftaran JumlahBayar KodePembayaran BankPengirim [namaPengirim]
                              <br/><br/>Contoh:<br/>
                              BAYAR Individu 50010 001 BCA [Yehezkiel Khakam Santoso]</p>
                          </p>
                                  ...
                                  <tbody>
                                    <tr>
                                      <td align="center"><table border="0" cellpadding="0" cellspacing="0" style="margin:0 auto;">
                                          <tr>
                                            <td width="250" height="60" align="center" bgcolor="#2c3e50"><a href="<?=base_url();?>" target="_blank" style="width:250; display:block; text-decoration:none; border:0; text-align:center; font-weight:bold;font-size:18px; font-family: Arial, sans-serif; color: #ffffff; background:#2c3e50" class="button_link">INConference 2017</a></td>
                                          </tr>
                                        </table></td>
                                    </tr>
                                  </tbody>
                 ...
                 <table width="100%" border="0" cellspacing="0" cellpadding="0">
                    <tr>
                      <td><table width="100%" cellpadding="0" cellspacing="0" border="0"  bgcolor="#2c3e50">
                        <tr>
                          <td height="6" align="center" bgcolor="#2c3e50" class="one-column">&nbsp;</td>
                        </tr>
                        <tr>
                           <td align="center" bgcolor="#2c3e50" class="one-column" style="padding: 10px;">
                              
                              <p style="color:#f0f0f0 !important; font-size:11px; text-align:center; font-family: Verdana, Geneva, sans-serif">
                        All rights reserved. Powered by INConference 2017 <br/>
                    ...
                    <tr>
                      <td><table width="100%" cellpadding="0" cellspacing="0" border="0"> 
                        <tr>
                          <td height="6" bgcolor="#2c3e50" class="contents" style="width:100%; border-bottom-left-radius:10px; border-bottom-right-radius:10px"></td>
                        </tr>
                        <tr>
                          <td>&nbsp;</td>
                        </tr>

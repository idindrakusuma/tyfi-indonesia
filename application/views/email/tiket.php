            ...
            <tr>
              <td style="padding-top:0;padding-bottom:0;padding-right:0;padding-left:0;"><!-- ======= start header ======= -->
                ...
                <table class="one-column" border="0" cellpadding="0" cellspacing="0" width="100%" style="border-spacing:0" bgcolor="#FFFFFF">
                  <tr>
                    <td align="left" style="padding:0px 40px 40px 40px"><p style="color:#5b5f65; font-size:24px; text-align:left; font-family: Verdana, Geneva, sans-serif">Terima Kasih, <?=$nama;?>!</p>
                      <p style="color:#5b5f65; font-size:14px; text-align:left; font-family: Verdana, Geneva, sans-serif">
                        Kami telah menerima dan memverifikasi pembayaran registrasi kamu. berikut merupakan E-Tiket kamu :
                      </p>
                      <div style="background-color: #fff; padding: 20px 5px 5px 5px;-moz-border-radius: 15px; -webkit-border-radius: 15px; border-radius: 15px; border-style: solid; min-height: 7em;" >
                      <img src="https://api.qrserver.com/v1/create-qr-code/?size=100x100&data='.$id" alt="" align="left" style="margin-right: 1em;">
                        <ul style="color:#555; margin-top: 0px; list-style: none">
                        <li>E-Ticket : <b><?=$id;?></b></li>
                        <li>---</li>
                        <li><b><?=$nama;?></b></li>
                        <li>---</li>
                        <li>
                      ...
                      <br/><br/>
                       ...
                       <strong>Catatan :</strong>
                        <ul style="color:#5b5f65; margin-top: -10px;font-size:12px; text-align:left; font-family: Verdana, Geneva, sans-serif">
                          <li>Jika terdapat perubahan, silahkan hubungi Hana (+6287834429196 / WA). </li>
                          <li>E-Tiket ini diperlukan pada saat daftar ulang.</li>
                          <li>Jika tidak memiliki smartpone, E-Tiket dapat di print.</li>
                        </ul>
                         <p style="color:#5b5f65; font-size:14px; text-align:left; font-family: Verdana, Geneva, sans-serif">
                        Terima kasih, <br />
                        INConference 2017 </p>

<div class="tab-pane" id="syarat">
	<div class="row">
        <div class="col-sm-12">
            <h5 class="info-text"> Syarat dan Ketentuan Peserta</h5>
        </div>
			...
			<div class="form-group scroll">
                ...
                <p class="description">
                	<ol type="a">
                		...
                		<li>Pendaftaran dilakukan melalui website INConference www.inconference2017.com</li>
                		<li>Setelah melunasi biaya pendaftaran  mendapatkan email konfirmasi dari panitia, pendaftar dinyatakan sebagai peserta InConference</li>
